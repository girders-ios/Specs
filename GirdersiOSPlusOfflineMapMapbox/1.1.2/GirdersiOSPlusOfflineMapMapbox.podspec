Pod::Spec.new do |s|
  ...
  s.platform = :ios, '8.0'
  s.source = { :svn => 'https://girders-ios.extranet.netcetera.biz/nca-312-2/svn/girders-ios-plus-offline-map/mapbox/tags/1.1.2' }
  ...
  s.dependency 'GirdersiOSPlusOfflineMap', '1.1.2'
