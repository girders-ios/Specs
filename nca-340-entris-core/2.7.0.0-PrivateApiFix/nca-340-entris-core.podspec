...
Pod::Spec.new do |s|
  ...
  s.version = '2.7.0.0-PrivateApiFix'
  ...
  s.source = { :svn => 'https://finnova.extranet.netcetera.biz/nca-340-4/svn/integrationProjects/entris-core/ios/tags/2.7.0.0' }
  ...
  #
  s.dependency 'nca-340-core', '2.7.0-PrivateApiFix'
end
