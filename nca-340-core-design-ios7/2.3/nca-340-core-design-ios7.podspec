...
Pod::Spec.new do |s|
  ...
  s.source   = { :svn => 'https://finnova.extranet.netcetera.biz/nca-340-4/svn/core/ios/nca-340-core/branches/2.3_iOS7/'}
  ...
  s.xcconfig = { 'HEADER_SEARCH_PATHS' => '$(SDKROOT)/usr/include/libxml2', 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/nca-340-core-design-ios7/lib/"', 'OTHER_LDFLAGS' => '-framework smartscan' }
