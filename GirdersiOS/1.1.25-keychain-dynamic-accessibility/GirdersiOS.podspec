Pod::Spec.new do |s|
  s.name     = 'GirdersiOS'
  s.version = '1.1.25-keychain-dynamic-accessibility'
  ...
  s.platform = :ios, '7.0'
  s.source = { :svn => 'https://girders-ios.extranet.netcetera.biz/nca-312-2/svn/girders-ios/branches/1.1.25-keychain-dynamic-accessibility' }
