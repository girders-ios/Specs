Pod::Spec.new do |s|
  ...
  s.platform = :ios, '7.0'
  s.source = { :git => 'https://extranet.netcetera.biz/bitbucket/scm/nca312ios/girders-ios.git', :tag => 'release-1.2.4' }
  ...
  s.pod_target_xcconfig = {
    'GCC_PREPROCESSOR_DEFINITIONS[config=Coverage]' => 'COVERAGE=1',
  }
