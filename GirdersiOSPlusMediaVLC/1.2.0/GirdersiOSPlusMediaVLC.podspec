Pod::Spec.new do |s|
  s.name     = 'GirdersiOSPlusMediaVLC'
  s.version = '1.2.0'
  s.summary  = 'Podspec for the VLC implementation of GirdersiOSPlusMedia'
  s.homepage = 'http://www.netcetera.com'
  s.author   = 'Netcetera'
  s.description = 'This is the podspec which contains the VLC implementation of GirdersiOSPlusMedia'
  s.platform = :ios, '8.0'
  s.source = { :svn => 'https://girders-ios.extranet.netcetera.biz/nca-312-2/svn/girders-ios-plus-media/vlc/tags/1.2.0' }
