#
#  Be sure to run `pod spec lint MigrosBankP2PCore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "MigrosBankP2PCoreiOS"
  s.version = '1.0.0'
  s.summary      = "Core project for ngMID and P2P."

  s.description  = "Core project for the ngMID and P2P application."
  ...
  s.source = { :svn => 'https://mmbanc.extranet.netcetera.biz/mgb-008-8/svn/MigrosBankP2PCore' }
