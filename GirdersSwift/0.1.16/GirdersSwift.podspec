Pod::Spec.new do |s|
  ...
  s.author   = 'Netcetera'
  s.description = 'A framework that reduces development time for iOS applications.'
  s.platform = :ios, '9.0'
  s.source = { :git => 'https://extranet.netcetera.biz/bitbucket/scm/nca312ios/girders-swift.git', :tag => '0.1.16' }
  s.requires_arc = true
