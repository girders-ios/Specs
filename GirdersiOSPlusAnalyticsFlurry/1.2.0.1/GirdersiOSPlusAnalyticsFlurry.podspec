Pod::Spec.new do |s|
  s.name     = 'GirdersiOSPlusAnalyticsFlurry'
  s.version = '1.2.0.1'
  s.summary  = 'Podpsec for the Flurry implementation of GirdersiOSPlusAnalytics'
  s.homepage = 'http://www.netcetera.com'
  s.author   = 'Netcetera'
  s.description = 'This is the podspec which contains the Flurry implementation of GirdersiOSPlusAnalytics'
  s.platform = :ios, '8.0'
  s.source = { :svn => 'https://girders-ios.extranet.netcetera.biz/nca-312-2/svn/girders-ios-plus-analytics/flurry/tags/1.2.0' }
  ...
  s.dependency 'GirdersiOSPlusAnalytics', '1.2.0.1'
