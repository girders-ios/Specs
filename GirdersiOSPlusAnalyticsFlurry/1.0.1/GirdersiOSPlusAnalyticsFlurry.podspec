Pod::Spec.new do |s|
  ...
  s.platform = :ios, '8.0'
  s.source = { :svn => 'https://girders-ios.extranet.netcetera.biz/nca-312-2/svn/girders-ios-plus-analytics/flurry/tags/1.0.1' }
  ...
  s.dependency 'GirdersiOSPlusAnalytics', '1.0.1'
