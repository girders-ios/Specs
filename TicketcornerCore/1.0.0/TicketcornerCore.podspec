Pod::Spec.new do |s|
  ...
  s.xcconfig = { 'HEADER_SEARCH_PATHS' => '$(SDKROOT)/usr/include/libxml2',
                 'OTHER_LDFLAGS' => '-framework Security, -framework CFNetwork, -framework SystemConfiguration, -framework Parse, -framework FBSDKLoginKit, -framework FBSDKLoginKit, -framework FBSDKShareKit' }
  s.requires_arc = true
