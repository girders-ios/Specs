Pod::Spec.new do |s|
  ...
  s.platform = :ios, '8.0'
  s.source = { :git => 'https://railvista-development.extranet.netcetera.biz/git/nca-395-1-railvista-development', :tag => '1.2.0' }
  ...
  s.dependency 'pearlchainModule', '1.0.3'
  ...
  s.subspec 'All' do |all|
    ...
    all.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'AccessInfo' do |accessInfo|
    ...
    accessInfo.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'AudioPlayer' do |audioPlayer|
    ...
    audioPlayer.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Book' do |book|
    ...
    book.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Highlight' do |highlight|
    ...
    highlight.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'ImageGallery' do |imageGallery|
    ...
    imageGallery.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'JourneyInformation' do |journeyInfo|
    ...
    journeyInfo.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'LanguageSelection' do |languageSelection|
    ...
    languageSelection.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Map' do |map|
    ...
    map.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Menu' do |menu|
    ...
    menu.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Notifications' do |notifications|
    ...
    notifications.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Pearlchain' do |pearlchain|
    ...
    pearlchain.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Settings' do |settings|
    ...
    settings.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Startup' do |startup|
    ...
    startup.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Stream' do |stream|
    ...
    stream.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'Tutorial' do |tutorial|
    ...
    tutorial.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
  ...
  s.subspec 'VideoPlayer' do |videoPlayer|
    ...
    videoPlayer.dependency 'RailVistaCore/Core', '1.2.0.0'
  end
end
