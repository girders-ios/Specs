Pod::Spec.new do |s|
  ...
  s.platform = :ios, '8.0'
  s.source = { :git => 'https://railvista-development.extranet.netcetera.biz/git/nca-395-1-railvista-development', :tag => '0.9' }
  ...
  s.dependency 'GirdersiOSPlusMediaVLC', '1.0'
  s.dependency 'GirdersiOSPlusAnalyticsFlurry', '1.0'
  s.dependency 'GirdersiOSPlusOfflineMapMapbox', '1.0'
