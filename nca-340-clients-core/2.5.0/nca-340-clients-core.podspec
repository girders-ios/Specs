...
Pod::Spec.new do |s|
  ...
  s.source   = { :svn => 'https://finnova.extranet.netcetera.biz/nca-340-4/svn/integrationProjects/clients-core/ios/trunk/'}
  s.description = 'Podfile for MobileBanking clients core product.'
