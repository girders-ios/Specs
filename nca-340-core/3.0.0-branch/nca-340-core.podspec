...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://extranet.netcetera.biz/bitbucket/scm/nca340finn/nca-340-4-ios.git', :branch => "feature/NCA340-4172-ios-implement-visual-design-for-szkb",  :submodules => true  }
