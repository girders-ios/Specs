...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://extranet.netcetera.biz/bitbucket/scm/nca340finn/nca-340-4-ios.git', :branch => "feature/NCA340-4051-ios-refine-implementation-of-financial-overview",  :submodules => true  }
  ...
  s.resources = 'src/**/*.xib', 'src/**/*.storyboard', 'src/common/**/*.png', 'src/common/**/*.html', 'src/common/**/*.strings', 'src/common/**/*.xml', 'src/common/**/*.mustache', 'src/common/**/termsOfUse.txt', 'src/common/**/touchIDTermsOfUse.txt', 'src/common/**/faceIDTermsOfUse.txt', 'src/common/**/GRConfiguration.plist', '/src/common/**/*.trm', 'src/common/**/texts.trm', 'src/common/resources/Images.xcassets', 'src/common/**/*.ttf'
