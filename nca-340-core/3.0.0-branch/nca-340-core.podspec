...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://extranet.netcetera.biz/bitbucket/scm/nca340finn/nca-340-4-ios.git', :branch => "feature/NCA340-4244-refine-activation-and-pairing-screens",  :submodules => true  }
