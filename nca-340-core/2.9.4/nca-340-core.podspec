...
Pod::Spec.new do |s|
  ...
  s.source = { :svn => 'https://finnova.extranet.netcetera.biz/nca-340-4/svn/core/ios/nca-340-core/branches/2.9.4' }
  ...
  s.resources = 'src/common/**/*.xib', 'src/common/**/*.png', 'src/common/**/*.html', 'src/common/**/*.strings', 'src/common/**/*.xml', 'src/common/**/*.mustache', 'src/common/**/termsOfUse.txt', 'src/common/**/faceIDTermsOfUse.txt', 'src/common/**/touchIDTermsOfUse.txt'
