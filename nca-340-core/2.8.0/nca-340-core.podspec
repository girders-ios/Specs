...
Pod::Spec.new do |s|
  ...
  s.source = { :svn => 'https://finnova.extranet.netcetera.biz/nca-340-4/svn/core/ios/nca-340-core/tags/2.8.0' }
  ...
  s.exclude_files = 'src/common/resources/Images.xcassets/*', 'src/common/resources/Info.plist', 'src/core/rolotec/**/*.{h,m}'
