...
Pod::Spec.new do |s|
  ...
  s.exclude_files = 'src/common/resources/Info.plist', 'src/core/rolotec/**/*.{h,m}', 'src/common/resources/Images.xcassets/AppIcon.appiconset/AppIcon29x29@2x.png'
  ...
  s.dependency 'GirdersiOS/All', '1.2.1'
