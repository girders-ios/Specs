...
Pod::Spec.new do |s|
  ...
  s.exclude_files = 'src/common/resources/Settings.bundle', 'src/common/resources/OfflineResources.bundle', 'src/common/resources/Info.plist', 'src/core/rolotec/**/*.{h,m}', 'src/common/resources/Images.xcassets/**/*.png'
