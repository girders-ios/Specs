...
Pod::Spec.new do |s|
  ...
  s.resources = 'src/**/*.xib', 'src/**/*.storyboard', 'src/common/**/*.png', 'src/common/**/*.html', 'src/common/**/*.strings', 'src/common/**/*.xml', 'src/common/**/*.mustache', 'src/common/**/termsOfUse.txt', 'src/common/**/touchIDTermsOfUse.txt', 'src/common/**/faceIDTermsOfUse.txt', '/src/common/**/*.trm', 'src/common/**/texts.trm'
