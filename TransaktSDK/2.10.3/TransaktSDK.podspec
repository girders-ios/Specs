...
Pod::Spec.new do |s|
  ...
  s.swift_version = '4.2'
  s.source       = { :http => "https://repo.netcetera.com/nexus/repository/thirdparty/com/entersekt/transact-sdk-ios/#{s.version}/transact-sdk-ios-#{s.version}-TransaktSDK.zip" }
