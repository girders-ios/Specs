#
#  Be sure to run `pod spec lint MobileTicketingCore.podspec' to ensure this is
...
Pod::Spec.new do |s|
  ...
  s.source = { :svn => 'https://wemlin-tickets.extranet.netcetera.biz/nca-376-8/svn/mobile/ios/core/tags/4.4.0' }
