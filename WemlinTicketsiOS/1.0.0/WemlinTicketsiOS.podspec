...
Pod::Spec.new do |s|
  ...
  s.source = { :svn => 'https://wemlin-tickets.extranet.netcetera.biz/nca-376-8/svn/mobile/ios/core/tags/1.0.0' }
  ...
  s.exclude_files = "src/main/resources/Info.plist, src/main/objc/main.m"
