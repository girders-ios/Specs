...
Pod::Spec.new do |s|
  ...
  s.summary  = 'MobileBanking SPI core product.'
  s.homepage = 'http://www.netcetera.com'
  s.author   = 'Netcetera'

  # Specify the location from where the source should be retreived.
  s.source = { :svn => 'https://finnova.extranet.netcetera.biz/nca-340-4/svn/integrationProjects/spi-core/ios/trunk' }
  s.description = 'Podfile for MobileBanking spi core product.'
  ...
  #
  s.dependency 'nca-340-core', '2.4.7'
end
