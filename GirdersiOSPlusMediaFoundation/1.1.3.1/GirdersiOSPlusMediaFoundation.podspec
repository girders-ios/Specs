Pod::Spec.new do |s|
  ...
  s.platform = :ios, '8.0'
  s.source = { :svn => 'https://girders-ios.extranet.netcetera.biz/nca-312-2/svn/girders-ios-plus-media/foundation/tags/1.1.3' }
  ...
  s.dependency 'GirdersiOSPlusMedia', '1.1.1.1'
end
